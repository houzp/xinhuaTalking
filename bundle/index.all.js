 ...
 * xinhua-talking v0.0.32
 * @time 2017-01-14-14.26.43
 */
...
$(function () {
    ...
    'index-assets/bg.jpg', 'index-assets/cover-logo.svg', 'index-assets/scenes1-btn-1-active-bg.png', 'index-assets/scenes1-btn-1-bg.png'];
    ...
    var scenes3SwiperInInit = function scenes3SwiperInInit(num) {
        new Swiper('#scenes3-in' + num, {
            ...
            onInit: function onInit(swiper) {
                ...
                var $nextPrev = $('#scenes3-in-prev' + num);
