...
d=c.geometry.triangles.length-1;d>=0;d--)e=c.geometry.triangles[d],f=e.color.format(),this.context.beginPath(),this.context.moveTo(e.a.position[0],e.a.position[1]),this.context.lineTo(e.b.position[0],e.b.position[1]),this.context.lineTo(e.c.position[0],e.c.position[1]),this.context.closePath(),this.context.strokeStyle=f,this.context.fillStyle=f,this.context.stroke(),this.context.fill();return this},!function(a,b){"function"==typeof define&&define.amd?define(b):"object"==typeof exports?module.exports=b():a.resLoader=b(a)}(this,function(){function a(a){if(this.option={resourceType:"image",baseUrl:"./",resources:[],onStart:null,onProgress:null,onComplete:null},!a)return void alert("参数错误！");for(i in a)this.option[i]=a[i];this.status=0,this.total=this.option.resources.length||0,this.currentIndex=0}var b=function(a){return"function"==typeof a};return a.prototype.start=function(){this.status=1;for(var a=this,c=this.option.baseUrl,d=0,e=this.option.resources.length;e>d;d++){var f=this.option.resources[d],g="";g=0===f.indexOf("http://")||0===f.indexOf("https://")?f:c+f;var h=new Image;h.onload=function(){a.loaded()},h.onerror=function(){a.loaded()},h.src=g}b(this.option.onStart)&&this.option.onStart(this.total)},a.prototype.loaded=function(){b(this.option.onProgress)&&this.option.onProgress(++this.currentIndex,this.total),this.currentIndex===this.total&&b(this.option.onComplete)&&this.option.onComplete(this.total)},a}),$(function(){var a="../bg-scenes2.hyperesources/bgscenes2_hype_generated_script.js",b="../bg-scenes4.hyperesources/bgscenes4_hype_generated_script.js",c="oldie"!==window.BROWSER.browser&&"ie9"!==window.BROWSER.browser,d="windows"===window.BROWSER.device,e=!1;d?"ie11"===window.BROWSER.browser&&(e=!0):e=!0,c||$(".cover-logo").after('\n            <div class="hackTips">\n                <h1 class="t1">Oops！似乎遇到了一些问题</h1>\n                <p>如果您能看到这个提示，这说明您的浏览器版本已经过于陈旧，<br>\n                我们建议您赶紧升级一下她们吧？</p>\n                <div class="t2">\n                    PS: 公元2015年微软放弃了ie10和以下浏览器的安全更新，<br>2016年某宝某猫某某巴巴已经都不支持ie8、9、10了！<br>\n                    如果您还在用这些浏览器会使您的网络存在极大的安全风险！\n                </div>\n                <span class="t3">一些有用的信息：'+window.BROWSER.browser+" + "+window.BROWSER.device+"<br>\n                "+window.BROWSER.UA+"\n                </span>\n            </div>");var f=$(window),g=$("body"),h=$(".top-nav"),i=null,j=null,k=0,l=null,m=$("#scenes1"),n=m.find(".swiper-pagination"),o=m.find(".swiper-button-next"),p=m.find(".swiper-slide").find(".scenes-ani-left"),q=m.find(".swiper-slide").find(".scenes1-pic"),r=null,s=$("#scenes2"),t=s.find(".swiper-slide"),u=s.find(".item"),v=["index-assets/bg.jpg","index-assets/cover-logo.svg","index-assets/scenes1-btn-1-active-bg.png","index-assets/scenes1-btn-1-bg.png"],w=new resLoader({resources:v,onStart:function(a){m.hide()},onProgress:function(a,b){},onComplete:function(a){"oldie"!==window.BROWSER.browser&&"ie9"!==window.BROWSER.browser&&(x.init(),ra.init())}}),x={$cover:$("#cover"),timeout:null,init:function(a){this.$cover.length&&0!==a&&window.location.hash.lastIndexOf("no-cover")<0?(this.coverClear(),this.coverTimeout(),this.coverClick()):(this.$cover.remove(),i="hide")},coverClick:function(){var a=this;a.$cover.on("click",function(){TweenMax.killAll(),a.coverHide(),a.coverClear()})},coverClear:function(){clearTimeout(this.timeout),this.timeout=null},coverTimeout:function(){var a=this;a.timeout=setTimeout(function(){a.coverHide()},200)},coverHide:function(){i="hide";var a=this,b=2.5;g.addClass("overflow-hidden"),e?TweenMax.to(a.$cover.find(".cover-logo"),b,{scale:8,ease:Power4.easeInOut,onStart:function(){TweenMax.to(a.$cover,1.2*b,{opacity:0,ease:Power4.easeInOut,onStart:function(){a.$cover.off("click"),setTimeout(function(){0===k&&B()},.5*b*1e3),setTimeout(function(){2===k&&ba()},.1*b*1e3)},onComplete:function(){a.$cover.remove(),g.removeClass("overflow-hidden")}})}}):(setTimeout(function(){0===k&&B()},.5*b*1e3),a.$cover.fadeOut("3000"),g.removeClass("overflow-hidden"))}},y={zoomSets:function(){if(f.height()<1080){$("#scenes2").addClass("ctlHeight")}else $("#scenes2").removeClass("ctlHeight")},init:function(){var a=this;f.on("resize",function(){a.zoomSets()}),a.zoomSets()}},z=function(a){"hide"===i&&0===a?B():A()},A=function(){TweenMax.to(h,0,{y:200,opacity:0}),TweenMax.to(n,0,{y:-200,opacity:0}),TweenMax.to(p,0,{x:200,opacity:0}),TweenMax.to(q,0,{x:-200,opacity:0}),o.removeClass("active")},B=function(){TweenMax.to(h,2,{y:0,opacity:1,ease:Power0.ease}),TweenMax.to(n,2.5,{y:0,opacity:1,ease:Power0.ease}),TweenMax.to(p,2.5,{x:0,opacity:1,ease:Power0.ease}),TweenMax.to(q,2,{x:0,opacity:1,ease:Power0.ease,onStart:function(){o.addClass("active")}})},C=function(a,b){"show"===b?e&&t.eq(a).find(".item").each(function(a,b){TweenMax.to($(b),.4,{x:0,opacity:1,delay:.1*a})}):"hide"===b&&e&&t.eq(a).find(".item").each(function(a,b){D($(b),.4,.08*a)})},D=function(a,b,c){e&&TweenMax.to(a,b,{x:30,opacity:0,delay:c})},E=function(a){TweenMax.to(a,.2,{scale:1.25,"box-shadow":"6px 6px 32px rgba(0, 0, 0, 0.35)",onStart:function(){a.css({"z-index":2}),TweenMax.to(a.find(".mask"),.8,{opacity:0})},onComplete:function(){G(a)}})},F=$("#scenes2-title-box"),G=function(a){var b=a.find(".t1").html(),c=a.find(".t2").html(),d=a.find(".t3").html();"undefined"===b&&(b=""),"undefined"===c&&(c=""),"undefined"===d&&(d=""),F.stop(!1,!0).fadeOut("2000",function(){$(this).html('\n                <div class="t2 title-2">'+c+'</div>\n                <div class="t3 title-3">'+d+'</div>\n                <div class="t1 title-1">'+b+"</div>").fadeIn("2000")})},H=function(a,b){TweenMax.to(a,1.2,{scale:1,"box-shadow":"none",onStart:function(){TweenMax.to(a.find(".mask"),1.2,{opacity:1}),a.css({"z-index":1})}})},I=function(b){1===b?null===r?r=new Swiper("#scenes2",{lazyLoading:!0,effect:"fade",autoplay:8e3,prevButton:"#scenes2 .swiper-button-prev",nextButton:"#scenes2 .swiper-button-next",paginationClickable:!0,speed:1800,onInit:function(b){e&&$.getScript(a),D(u,0,0),C(b.activeIndex,"show",1);var c=0,d=u.eq(c);setTimeout(function(){E(d)},2500),u.on("mouseover",function(){var a=$(this);a.index()!==c&&H(d),E(a)}),u.on("mouseout",function(){var a=$(this);H(a)}),y.init()},onSlideChangeStart:function(a){C(a.activeIndex,"show"),C(a.previousIndex,"hide")}}):(r.unlockSwipes(),C(r.activeIndex,"show")):null!==r&&(r.lockSwipes(),D(u,0,0))},J=null,K=new Array,L=new Array,M=$("#scenes3"),N=M.find(".scenes3-container-in .swiper-slide"),O=function(a){e&&_(k),2===k?null===J?(Q(),e&&oa(k,2),J=new Swiper(M.selector,{lazyLoading:!0,pagination:"#scenes3-pagination",prevButton:"#scenes3-prev",nextButton:"#scenes3-next",speed:e&&3e3||0,onInit:function(a){T(),P(a),e||void 0!==K[0]||(K[0]=V(0)),a.nextButton.on("click",function(){void 0===K[a.realIndex]&&(K[a.realIndex]=V(a.realIndex))})},onSlideChangeStart:function(a){P(a)},onSlideChangeEnd:function(a){S(a.slides.eq(a.realIndex).find(".swiper-slide:eq(0)"))}})):J.unlockSwipes():null!==J&&J.lockSwipes()},P=function(a){var b=[a.realIndex-1,a.realIndex+1];b[0]<0&&(b[0]=L.length-1),b[1]>=L.length&&(b[1]=0),U(a.prevButton,b[0]),U(a.nextButton,b[1])},Q=function(){N.on("mouseover mouseout",function(a){var b=$(this);"mouseover"===a.type?(R(b.siblings()),S(b)):"mouseout"===a.type&&R(b)})},R=function(a){a.removeClass("active")},S=function(a){a.addClass("active")},T=function(){M.find(".scenes3-container-in").each(function(a,b){var c=$(b);L.push({title:"\n                        "+$.trim(c.find(".t1").text())+'\n                        <div class="a">\n                            '+$.trim(c.find(".t2").text())+"\n                        </div>",img:$.trim(c.find(".t3").attr("src"))})})},U=function(a,b){a.html('\n                <div class="swiper-button-content">\n                    <div class="p">\n                        <img src="'+L[b].img+'" width="auto" height="102">\n                    </div>\n                    <div class="t">'+L[b].title+'</div>\n                </div>\n                <div class="icon"></div>\n                <div class="b"></div>')},V=function sa(a){new Swiper("#scenes3-in"+a,{lazyLoading:!0,paginationClickable:!0,slidesPerView:5,slidesPerGroup:5,spaceBetween:30,nested:!0,onInit:function(b){0===a&&S(b.slides.eq(0));var c=$("#scenes3-in-next"+a),d=$("#scenes3-in-prev"+a);c.off("click"),c.on("click",function(){b.slideNext(),b.isEnd&&($(this).off("click"),$(this).click(function(){void 0===K[a+1]&&(K[a+1]=sa(a+1)),J.slideNext()}))}),d.off("click"),d.on("click",function(){b.slidePrev(),b.isBeginning&&($(this).off("click"),$(this).click(function(){J.slidePrev()}))})}})},W=M.find(".swiper-slide:eq(0)"),X=W.find(".scenes3-title"),Y=W.find(".scenes3-absract"),Z=W.find(".swiper-container"),_=function(a){"hide"===i&&2===a?ba():aa()},aa=function(){TweenMax.to(X,0,{y:200,opacity:0}),TweenMax.to(Y,0,{y:200,opacity:0}),TweenMax.to(Z,0,{y:-100,opacity:0}),la()},ba=function(a){TweenMax.to(X,a||2.2,{y:0,opacity:1,ease:Power0.ease,onComplete:function(){void 0===K[0]&&(K[0]=V(0))}}),TweenMax.to(Y,1.4,{y:0,opacity:1,ease:Power0.ease}),TweenMax.to(Z,2,{y:0,opacity:1,ease:Power0.ease}),ma()},ca=null,da=function(a){null===ca&&(ca=$.getScript(b))},ea=function(a){3===k&&e&&da(a)},fa=$("#nav"),ga=fa.find(".nav-line"),ha=fa.find(".nav-btn-box a");ha.on("mouseover",function(){ia($(this).index()-1,.3)});var ia=function(a,b){TweenMax.to(ga,b,{x:120*a})};ha.on("click",function(a){return a.preventDefault(),j.slideTo($(this).index()-1),!1});var ja=null,ka=null,la=function(){null!==ja&&TweenMax.to(ka,0,{opacity:0})},ma=function(){null!==ja&&TweenMax.to(ka,3,{opacity:.2,onStart:function(){$(".scenes3").css({background:"none"})}})},na=function(){var a=$("#triangleBg"),b=$("#triangleBg-anitOut");if(document.createElement("canvas").getContext){var c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s;!function(){var t=function(){u(),w(),x(),y(),D(),z(l.offsetWidth,l.offsetHeight),A()},u=function(){s=new CAV.CanvasRenderer,v(g.renderer)},v=function(a){switch(n&&m.removeChild(n.element),a){case e:n=s}n.setSize(l.offsetWidth,l.offsetHeight),m.appendChild(n.element)},w=function(){o=new CAV.Scene},x=function(){o.remove(p),n.clear(),q=new CAV.Plane(c.width*n.width,c.height*n.height,c.segments,c.slices),r=new CAV.Material(c.ambient,c.diffuse),p=new CAV.Mesh(q,r),o.add(p);var a,b;for(a=q.vertices.length-1;a>=0;a--)b=q.vertices[a],b.anchor=CAV.Vector3.clone(b.position),b.step=CAV.Vector3.create(Math.randomInRange(.2,1),Math.randomInRange(.2,1),Math.randomInRange(.2,1)),b.time=Math.randomInRange(0,Math.PIM2)},y=function(){var a,b;for(a=o.lights.length-1;a>=0;a--)b=o.lights[a],o.remove(b);for(n.clear(),a=0;a<d.count;a++)b=new CAV.Light(d.ambient,d.diffuse),b.ambientHex=b.ambient.format(),b.diffuseHex=b.diffuse.format(),o.add(b),b.mass=Math.randomInRange(.5,1),b.velocity=CAV.Vector3.create(),b.acceleration=CAV.Vector3.create(),b.force=CAV.Vector3.create()},z=function(a,b){n.setSize(a,b),CAV.Vector3.set(j,n.halfWidth,n.halfHeight),x()},A=function F(){h=Date.now()-i,B(),C(),requestAnimationFrame(F)},B=function(){var a,b,e,f,g,i,l,m=c.depth/2;for(CAV.Vector3.copy(d.bounds,j),CAV.Vector3.multiplyScalar(d.bounds,d.xyScalar),CAV.Vector3.setZ(k,d.zOffset),f=o.lights.length-1;f>=0;f--){g=o.lights[f],CAV.Vector3.setZ(g.position,d.zOffset);var n=Math.clamp(CAV.Vector3.distanceSquared(g.position,k),d.minDistance,d.maxDistance),p=d.gravity*g.mass/n;CAV.Vector3.subtractVectors(g.force,k,g.position),CAV.Vector3.normalise(g.force),CAV.Vector3.multiplyScalar(g.force,p),CAV.Vector3.set(g.acceleration),CAV.Vector3.add(g.acceleration,g.force),CAV.Vector3.add(g.velocity,g.acceleration),CAV.Vector3.multiplyScalar(g.velocity,d.dampening),CAV.Vector3.limit(g.velocity,d.minLimit,d.maxLimit),CAV.Vector3.add(g.position,g.velocity)}for(i=q.vertices.length-1;i>=0;i--)l=q.vertices[i],a=Math.sin(l.time+l.step[0]*h*c.speed),b=Math.cos(l.time+l.step[1]*h*c.speed),e=Math.sin(l.time+l.step[2]*h*c.speed),CAV.Vector3.set(l.position,c.xRange*q.segmentWidth*a,c.yRange*q.sliceHeight*b,c.zRange*m*e-m),CAV.Vector3.add(l.position,l.anchor);q.dirty=!0},C=function(){n.render(o)},D=function(){window.addEventListener("resize",E)},E=function(a){z(l.offsetWidth,l.offsetHeight),C()};c={width:.8,height:1,depth:40,segments:5,slices:0,xRange:.5,yRange:.2,zRange:1,ambient:"#444444",diffuse:"#FFFFFF",speed:3e-4},d={count:2,xyScalar:1,zOffset:100,ambient:"#FFFFFF",diffuse:"#FFFFFF",speed:.001,gravity:1200,dampening:.95,minLimit:10,maxLimit:1,minDistance:20,maxDistance:400,autopilot:!1,draw:!1,bounds:CAV.Vector3.create(),step:CAV.Vector3.create(Math.randomInRange(.2,1),Math.randomInRange(.2,1),Math.randomInRange(.2,1))},e="canvas",f="svg",g={renderer:e},i=Date.now(),j=CAV.Vector3.create(),k=CAV.Vector3.create(),l=a[0],m=b[0],t()}()}else a.remove()},oa=function(a,b){a===b&&null===ja&&(ka=$("#triangleBg"),ja=na(),ma())},pa=null,qa=function(a){null===pa&&4===a&&!function(){var a=function(){f.height()<900?$(".footer").css({bottom:-80}):$(".footer").css({bottom:0})};pa=scense_five(),f.on("resize",function(){a()}),a()}()},ra={$nav:fa,navHeight:67,$scenes1:m,scenes1:null,init:function(){var a=this;j=new Swiper("#main",{lazyLoading:!0,speed:e&&1e3||500,hashnavWatchState:!0,direction:"vertical",keyboardControl:!0,mousewheelControl:!0,runCallbacksOnInit:!0,onInit:function(b){a.getSize(),a.navHeight=a.$nav.height(),f.on("resize",function(){k<1&&a.getSize(),a.navSetPosition(k)}),a.scenes1Init(b.realIndex)},onSlideChangeStart:function(b){k=b.realIndex,a.navSetPosition(b.realIndex),I(b.realIndex),qa(b.realIndex)},onSlideChangeEnd:function(b){ia(b.realIndex,1),a.scenes1Init(b.realIndex),O(b.realIndex),ea(b.realIndex)}})},scenes1Init:function(a){m.show();var b=this;e&&z(a),0===a?(b.zoom(),null===l?l=new Swiper("#scenes1",{spaceBetween:200,lazyLoading:!0,parallax:!!e,pagination:"#scenes1-pagination",prevButton:"#scenes1-prev",nextButton:"#scenes1-next",paginationClickable:!0,speed:e?3e3:1100,runCallbacksOnInit:!0,onInit:function(a){b.getSwiperData(),b.qrcode(),q.on("mouseover",function(){TweenMax.to($(this),.8,{x:30})}).on("mouseout",function(){TweenMax.to($(this),.8,{x:0})}),a.nextButton.on("mouseout",function(){a.nextButton.removeClass("active")}),a.prevButton.on("mouseover",function(){a.nextButton.removeClass("active")});var c=[a.realIndex-1,a.realIndex+1];c[0]<0&&(c[0]=b.data.length-1),c[1]>=b.data.length&&(c[1]=0),b.setSwiperButton(a.prevButton,c[0]),b.setSwiperButton(a.nextButton,c[1])},onSlideChangeStart:function(a){var c=[a.realIndex-1,a.realIndex+1];c[0]<0&&(c[0]=b.data.length-1),c[1]>=b.data.length&&(c[1]=0),b.setSwiperButton(a.prevButton,c[0]),b.setSwiperButton(a.nextButton,c[1])}}):l.unlockSwipes()):null!==l&&l.lockSwipes()},getSwiperData:function(){var a=this;a.data=new Array,m.find(".swiper-slide").each(function(b,c){var d=$(c);a.data.push({title:$.trim(d.find(".scenes1-title-1").text()),img:d.find(".scenes1-pic img").attr("src")})})},setSwiperButton:function(a,b){var c=this;a.html('\n                    <div class="swiper-button-content">\n                        <div class="p">\n                            <img src="'+c.data[b].img+'" width="102" height="auto">\n                        </div>\n                        <div class="t">'+c.data[b].title+'</div>\n                    </div>\n                    <div class="icon"></div>\n                    <div class="b"></div>')},getSize:function(){this.size={height:f.height(),width:f.width()}},qrcode:function(){var a=m.find(".scenes1-qrcode");a.each(function(a,b){var c=$(b);c.qrcode({correctLevel:1,foreground:"#333",width:108,height:108,text:$.trim(c.find(".scenes1-qrcode-url").text())})})},zoomTags:[{tag:".scenes1-logo"},{tag:".scenes1-title-top"},{tag:".scenes1-title-1"},{tag:".scenes1-title-4"},{tag:".scenes1-content"}],zoomResize:null,zoomRatio:function(a){return Math.round(a*this.size.height/1080)},zoomSet:function(a){var b=this,c={top:b.zoomRatio(a.num)};"height"===a.type&&(c={height:b.zoomRatio(a.num)}),a.tag.css(c)},zoomSets:function(){this.getSize();for(var a=0,b=this.zoomTags.length;a<b;a++)this.zoomTags[a].num||(this.zoomTags[a].tag=this.$scenes1.find(this.zoomTags[a].tag),"height"!==this.zoomTags[a].type?this.zoomTags[a].num=this.zoomTags[a].tag.offset().top:this.zoomTags[a].num=this.zoomTags[a].tag.outerHeight()),this.zoomSet(this.zoomTags[a])},zoom:function(){var a=this;null===a.zoomResize&&(a.zoomResize=f.on("resize",function(){a.zoomSets()})),a.zoomSets()},navSetPositionAnis:function(a,b,c){e?TweenMax.to(this.$nav,b,{top:a,bottom:"auto",onComplete:c||null}):this.$nav.css({top:a,bottom:"auto"})},navSetPosition:function(a){var b=this;a<1?b.navSetPositionAnis(b.size.height-b.navHeight,.6,function(){b.$nav.removeClass("nav-isTop")}):b.navSetPositionAnis(0,.6,function(){b.$nav.addClass("nav-isTop")})}};w.start()});