...
$(function () {
     ...
     * scenes1Page1
    ------------------------------------------------------------------------- */
    var scenes1Page1Hide = function scenes1Page1Hide() {
    ...
    var scenes1Page1Show = function scenes1Page1Show() {
    ...
    var scenes3SwiperIn = null;
    var scenes3Data = null;
    // let scenes3SwiperRealIndex = 0;
    var $scenes3 = $('#scenes3');
    var $scenes3InSlide = $scenes3.find('.scenes3-container-in .swiper-slide');

    var scenes3BgInit = function scenes3BgInit(swiperRealIndex) {
    ...
    var scenes3Btn = function scenes3Btn(num) {
    ...
    var scenes3GetSwiperData = function scenes3GetSwiperData() {
        ...
        $scenes3.find('.scenes3-container-in').each(function (i, e) {
            ...
            scenes3Data.push({
                ...
                img: $e.find('.swiper-slide:eq(0) .p img').attr('src')
            });
        });
    };
    ...
    var xinhuaTalking = {
        ...
        scenes1Init: function scenes1Init() {
            var _this = this;
            if (mainSwiperRealIndex === 0) {
                _this.zoom();
        ...
        qrcode: function qrcode() {
            var qrcodes = this.$scenes1.find('.scenes1-qrcode');
