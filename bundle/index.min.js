...
$(function () {
    ...
    '../xinhuaTalking/index-assets/bg.jpg', '../xinhuaTalking/index-assets/cover-logo.png', '../xinhuaTalking/index-assets/scenes-1-btn-1-active-bg.png', '../xinhuaTalking/index-assets/scenes-1-btn-1-bg.png'];
    ...
    var xinhuaTalking = {
        ...
        zoom: function zoom() {
            ...
            var ratio = function ratio(num) {
                return Math.round(num * _this2.size.height / 1080);
            };
            var set = function set(opt) {
                var css = {
                    top: ratio(opt.num)
                };
                if (opt.type === 'height') {
            ...
            var init = function init() {
                ...
                for (var i = 0, j = tags.length; i < j; i++) {
                    if (!tags[i].num) {
                        tags[i].tag = _this2.$scenes1.find(tags[i].tag);
        ...
        navStatus: function navStatus(activeIndex) {
            var _this = this;
            if (activeIndex < 1) {
        ...
        scenesMain: function scenesMain(time) {
            var _this = this;
        ...
        scenes: function scenes(num, callback) {
