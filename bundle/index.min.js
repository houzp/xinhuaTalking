...
$(function () {
    ...
    var $topNav = $('.top-nav');
    var $slideLeft = $scenes1.find('.swiper-slide').eq(0).find('.scenes-ani-left');
    var $slidePic = $scenes1.find('.swiper-slide').eq(0).find('.scenes-1-pic img');

    // scenes1_page1Ani
    var scenes1_set = function scenes1_set() {
    ...
    var scenes1_page1Ani = function scenes1_page1Ani() {
        ...
        TweenMax.to($slidePic, 2.5, {
            ...
            onComplete: function onComplete() {
                ...
                var activeBtn = $scenes1.find('.swiper-button-next');
